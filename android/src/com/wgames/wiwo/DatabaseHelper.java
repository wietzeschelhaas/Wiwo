...
public class DatabaseHelper extends SQLiteOpenHelper implements DataBaseHandler{
    ...
    private static String TABLE_NAME = "tbl";
    ...
    public DatabaseHelper(Context context) {
        ...
        DB_PATH = myContext.getApplicationContext().getDatabasePath("en").toString();
    }
    ...
    public boolean checkWord(String s){
        Cursor res = myDataBase.rawQuery("select * from " + TABLE_NAME + " where word = " + "\"" + s + "\"",null);
